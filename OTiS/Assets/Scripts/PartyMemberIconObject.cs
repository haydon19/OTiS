...
public class PartyMemberIconObject : MonoBehaviour, IPointerClickHandler
{
    Image sprite;
    Text description;
    Character character;
    ...
    public void Awake()
    {
        ...
        Sprite = transform.FindChild("PortraitMask/CharacterIcon").gameObject.GetComponent<Image>();
    }
